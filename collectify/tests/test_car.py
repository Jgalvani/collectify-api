...
class CarTest(APITestCase):
    ...
    def test_create_car_without_color(self):
        ...
        # Car name from database should be "Tesla_test".
    ...
    def test_create_car_with_colors(self):
        ...
        car_colors = [{'id': color.id, 'name': color.name} for color in Car.objects.first().colors.all()]
        ...
        self.assertEqual(car_colors, created_colors)
    ...
    def test_retrieve_car_without_color(self):
        ...
        # Car name from response should be "Tesla_test".
    ...
    def test_retrieve_car_with_colors(self):
        ...
        self.assertEqual(retrieve_response.data['name'], 'Tesla_test')
        # Colors from car should be the same as created colors.
        self.assertEqual(created_colors, retrieve_response.data['colors'])
    ...
    def test_list_cars(self):
        ...
        self.assertEqual(created_cars, list_response.data)
    ...
    def test_update_car_name(self):
        ...
        # Car name from update response should not be "Tesla_test".
        self.assertNotEqual(update_response.data['name'], 'Tesla_test')
        # Car name from update response should be "BMW_test".
    ...
    def test_update_car_colors(self):
        ...
        # Car name from update response should be "Tesla_test".
